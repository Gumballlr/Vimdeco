                        ...
                        <div class="modal-content">
                          ...
                          <form action="" method="POST" class="form" autocomplete="off">
                            ...
                            <div class="modal-header">
                              <h5 style="font-size: 18px" class="modal-title" id="exampleModalLongTitle">THÊM TÀI KHOẢN
                              </h5>
                                ...
                                <div class="col-md-4 mb-4">
                                  <div class="form-group">
                                    <label for="inputPasswordOld">
                                      <h6 style="color:black">Tên tài khoản</h6>
                                    </label>
                                ...
                                <div class="col-md-4 mb-4">
                                  <div class="form-group">
                                    <label for="inputPasswordNew">
                                      <h6 style="color:black">Mật khẩu</h6>
                                    </label>
